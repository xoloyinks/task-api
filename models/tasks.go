...
type Column struct {
	ID      bson.ObjectID `bson:"_id,omitempty" json:"id"`
	BoardID bson.ObjectID `bson:"board_id" json:"board_id"`
...
type Task struct {
	...
	DestinationID string        `bson:"destination_id" json:"destination_id"`
	BoardID       bson.ObjectID `bson:"board_id" json:"board_id"`
	ColumnID      bson.ObjectID `bson:"column_id" json:"column_id"`
...
type UpdateTask struct {
	BoardID     *bson.ObjectID `json:"board_id"` // client sends this
...
type CreateColumn struct {
	...
	Name    string `json:"name" validate:"required,oneof=todo 'in progress' completed"`
}
